...
Route::get('/card-product-remove/{id}', [CartController::class, 'remove'])->name('card-product-remove');
Route::post('/update-qty/{id}', [CartController::class, 'updateQty'])->name('update-qty');
