                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="xzoom-container">
                            <div class="main-img">
                                <img class="xzoom" id="xzoom-default" src="{{asset($details->image)}}" xoriginal="{{asset($details->image)}}" />
                            </div>
                            <div class="xzoom-thumbs images">
                                @foreach($OtherImages as $OtherImage)
                                    <a href="{{asset($OtherImage->image)}}"><img class="xzoom-gallery img" width="80" src="{{asset($OtherImage->image)}}"  xpreview="{{asset($OtherImage->image)}}" title="The description goes here"></a>
                                @endforeach
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <h3 class="price">{{ $details->selling_price }} <span class="deleted">{{ $details->regular_price }}</span></h3>
                            <p class="info-text">{{ $details->short_description }}</p>
                            <form action="{{ route('add-to-card',['id'=>$details->id]) }}" method="post">
                                @csrf
                                <div class="row">
                                ...
                                <div class="row align-items-end">
                                    <div class="col-lg-4 col-md-4 col-12">
                                        <div class="button cart-button">
                                            <button type="submit" href="" class="btn pt-2" style="width: 100%;">Add to Cart</button>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-12">
